...
declare class PostController {
     ...
     */
    static listarPostPorFiltro(req: Request, res: Response, next: NextFunction): Promise<void>;
    /**
     * @swagger
     * /posts:
     *   get:
     ...
     *         description: Erro interno do servidor
     */
    static listarPosts(req: Request, res: Response, next: NextFunction): Promise<void>;
    /**
     * @swagger
     * /posts/professor:
     *   get:
     ...
     *         description: Erro interno do servidor
     */
    static listarPostsProfessor(req: Request, res: Response, next: NextFunction): Promise<void>;
    /**
     * @swagger
     * /posts/{id}:
     *   get:
